...
from src.main10a_cmp_repair import (
...
class TestLoadPipeFatigueData:
    ...
    @patch("src.main10a_cmp_repair.load_fatigue_data")
...
class TestLoadPipeShapefiles:
    ...
    @patch("src.main10a_cmp_repair.load_pipe_shapefile")
...
class TestPlotPipeFatigueWithRepair:
    ...
    @patch("src.main10a_cmp_repair.setup_korean_font")
    @patch("src.main10a_cmp_repair.setup_plot_style")
    @patch("src.main10a_cmp_repair.prepare_fatigue_data")
    @patch("src.main10a_cmp_repair.plot_smlz_background")
    @patch("src.main10a_cmp_repair.create_fatigue_colormap")
    @patch("src.main10a_cmp_repair.create_log_norm")
    @patch("src.main10a_cmp_repair.plot_fatigue_pipes")
    @patch("src.main10a_cmp_repair.add_fatigue_colorbar")
    @patch("src.main10a_cmp_repair.calculate_fatigue_statistics")
    @patch("src.main10a_cmp_repair.format_fatigue_stats_text")
    ...
    @patch("src.main10a_cmp_repair.calculate_fatigue_statistics")
    @patch("src.main10a_cmp_repair.format_fatigue_stats_text")
    @patch("src.main10a_cmp_repair.plot_repair_points_on_pipe")
...
class TestMain:
    ...
    @patch("src.main10a_cmp_repair.load_pipe_fatigue_data")
    @patch("src.main10a_cmp_repair.load_all_repair_data")
    @patch("src.main10a_cmp_repair.load_pipe_shapefiles")
    @patch("src.main10a_cmp_repair.get_fatigue_by_ftr_idn")
    @patch("src.main10a_cmp_repair.plot_pipe_fatigue_with_repair")
    @patch("src.main10a_cmp_repair.get_smlz_shapefile_path")
    ...
    def test_main_basic(
        ...
        with patch("sys.argv", ["main10a_cmp_repair.py"]):
            main()
    ...
    def test_main_with_no_repair_option(
        ...
        with patch("sys.argv", ["main10a_cmp_repair.py", "--no-repair"]):
            main()
